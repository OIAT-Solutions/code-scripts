...
def get_or_create_item_id(
    ...
    if not item_id and auto_create_items:
        ...
        if mapping_cache is None:
            ...
            from code_scripts.qbo_items import get_or_create_service_item
...
def main():
    ...
    if args.bypass_inventory_startdate:
        ...
        from code_scripts.qbo_items import get_or_create_service_item, load_blocker_item_ids_from_csv
